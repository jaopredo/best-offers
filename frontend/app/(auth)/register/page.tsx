...
import type { UserRegisterFormInterface } from "@/types/api/services/auth.service"
...
export default function Register() {
    ...
    const methods = useForm<UserRegisterFormInterface>()
    ...
    const onSubmit: SubmitHandler<UserRegisterFormInterface> = (data) => {
    ...
    return <main className={`w-screen h-screen flex items-center justify-center transition-colors overflow-hidden ${theme == 'light' ? 'bg-stone-300' : 'bg-[#10161F]'}`}>
        <section className={`w-[90%] md:w-[60vw] p-10 rounded-md flex items-center justify-center flex-col transition-colors ${theme == 'light' ? 'bg-[#F5F5F5]' : 'bg-[#233E51]'}`}>
            ...
            <FormProvider {...methods}>
                ...
                >
                    ...
                    <div className="flex flex-col md:flex-row gap-5 w-full items-center justify-between">
                        <Password
                            name="password"
                            label="Senha"
                        ...
                        <Password
                            ...
                            help="Confirme a senha do usuário"
                            validation={{
                                required: {
                                    value: true,
                                    message: "Esse campo é obrigatório"
