...
/* DTO */
import { ItemPostDto } from 'types/item/item.dto';
...
export class ItemService {
    ...
    async update(id: number, item: Partial<ItemPostDto>) {
        ...
        const { fontId: _fontId, categoryId: _categoryId, ...safeItem } = item;
        const definitiveSafeItem = {
            ...foundItem,
            ...removeUndefined(safeItem),
        };

        return await this.itemRepository.save(definitiveSafeItem);
    }
